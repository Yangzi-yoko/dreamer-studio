...
async function seed(): Promise<void> {
  ...
  const menuDefs: MenuDef[] = [
    ...
    { key: 'member-packages', title: '次卡管理', path: '/member/packages', type: 'menu', permissionCode: 'member:package:list', sort: 5, parent: 'member' },
    { key: 'member-package-create', title: '新增次卡', type: 'button', permissionCode: 'member:package:create', sort: 1, parent: 'member' },
    { key: 'member-package-update', title: '编辑次卡', type: 'button', permissionCode: 'member:package:update', sort: 2, parent: 'member' },
    { key: 'member-package-delete', title: '删除次卡', type: 'button', permissionCode: 'member:package:delete', sort: 3, parent: 'member' },
