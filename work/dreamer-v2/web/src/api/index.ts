...
export const api = {
  ...
  createRechargeOrder: (amountYuan: number, remark?: string) => request.post<any, any>('/member/wallet/recharge-orders/me', { amountYuan, remark }),
  myRechargeOrders: () => request.get<any, any>('/member/wallet/recharge-orders/me'),
  payRechargeOrder: (id: number) => request.post<any, any>(`/member/wallet/recharge-orders/me/${id}/pay`, {}),
